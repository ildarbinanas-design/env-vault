...
func makeRepositoryReleaseSettingsProof(t *testing.T, contract releasecontract.Contract, authorization Authorization) releasesettings.Proof {
	...
	proof, err := releasesettings.Seal(contract, releasesettings.Tuple{
		...
		MergeSettings:   []byte(fmt.Sprintf(`{"data":{"repository":{"defaultBranchRef":{"name":"main"},"mergeCommitAllowed":false,"rebaseMergeAllowed":false,"squashMergeAllowed":true,"squashMergeCommitTitle":"PR_TITLE","squashMergeCommitMessage":"PR_BODY","rulesets":{"totalCount":3,"pageInfo":{"hasNextPage":false},"nodes":[{"databaseId":7,"name":"Protect env-vault main","enforcement":"ACTIVE","target":"BRANCH","source":{"__typename":"Repository","nameWithOwner":%q},"bypassActors":{"totalCount":0}},{"databaseId":8,"name":"Protect env-vault release tags","enforcement":"ACTIVE","target":"TAG","source":{"__typename":"Repository","nameWithOwner":%q},"bypassActors":{"totalCount":0}},{"databaseId":9,"name":"Protect env-vault release evidence","enforcement":"ACTIVE","target":"BRANCH","source":{"__typename":"Repository","nameWithOwner":%q},"bypassActors":{"totalCount":0}}]}}}}`, authorization.Repository, authorization.Repository, authorization.Repository)),
